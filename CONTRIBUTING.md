...
- **New MCP tools or servers:** update **[docs/mcp-servers-and-tools.md](docs/mcp-servers-and-tools.md)** and, if wiring or gather behavior changes, **[docs/mcp-and-agents.md](docs/mcp-and-agents.md)** / **[docs/architecture.md](docs/architecture.md)**. Gather is **incremental** (`_mcp_gather_complete`, merge + skip + partial saves in [`core.py`](src/genify/backend/agent/core.py)); extend **[tests/test_gather_incremental.py](tests/test_gather_incremental.py)** / **[tests/test_context_cache_persist.py](tests/test_context_cache_persist.py)** when changing persistence rules.
